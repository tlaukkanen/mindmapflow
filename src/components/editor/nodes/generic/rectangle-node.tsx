...
export default memo(function RectangleNode(props: RectangleNodeProps) {
  const getNodeStyle = () => {
    if (props.data.depth === 0)
      return "px-1 py-2 h-full w-full shadow-md rounded-md bg-white border-solid max-w-[250px]";
    if (props.data.depth === 1)
      return "px-1 py-1 h-full w-full shadow-md rounded-3xl bg-white border-solid max-w-[250px]";
